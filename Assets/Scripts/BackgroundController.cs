...
public class BackgroundController : MonoBehaviour
{
    ...
    [SerializeField] float m_scrollSpeedY = -0.005f;
    ...
    {
        // 背景画像をスクロールする
        m_backgroundSprite.transform.Translate(0f, m_scrollSpeedY, 0f);
        m_backgroundSpriteClone.transform.Translate(0f, m_scrollSpeedY, 0f);
